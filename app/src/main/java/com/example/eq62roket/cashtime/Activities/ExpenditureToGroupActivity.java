...
public class ExpenditureToGroupActivity extends AppCompatActivity {
    private static String TAG = "ExpenditureToGroupActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expenditure_to_group);

        mRecyclerView = (RecyclerView) findViewById(R.id.recycler_view);
        emptyView = (TextView) findViewById(R.id.empty_view);

        new ParseGroupHelper(ExpenditureToGroupActivity.this).getAllGroupsFromParseDb(new OnReturnedGroupsListener() {
            @Override
