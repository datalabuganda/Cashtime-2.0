...
public class IncomeToGroupActivity extends AppCompatActivity {
    private static final String TAG = "IncomeToGroupActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_income_to_group);

        mRecyclerView = (RecyclerView) findViewById(R.id.recycler_view);
        emptyView = (TextView) findViewById(R.id.empty_view);

        new ParseGroupHelper(IncomeToGroupActivity.this).getAllGroupsFromParseDb(new OnReturnedGroupsListener() {
            @Override
